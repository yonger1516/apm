...
import com.enniu.qa.apm.dao.AgentManagerRepository;
...
import static com.enniu.qa.apm.model.AgentManagerSpecification.startWithRegion;
...
public class LocalAgentService {
	...
	@Transactional
	public void updateAgents(List<GrinderAgentInfo> newAgents,
							 List<GrinderAgentInfo> updatedAgents,
							 List<GrinderAgentInfo> stateUpdatedAgents,
							 List<GrinderAgentInfo> removedAgents) {
		...
		for (GrinderAgentInfo each : stateUpdatedAgents) {
