...
import com.enniu.qa.apm.util.EncodingUtils;
...
public class Home2 {
	 ...
	 */
	public Home2(File directory, boolean create) {
	 ...
	 */
	private File getPerfTestSubDirectory(ApiTestRun perfTest, String subPath) {
	 ...
	 * @return {@link PerfTest} log directory
	 */
	public File getPerfTestLogDirectory(ApiTestRun perfTest) {
	 ...
	 */
	public File getPerfTestDistDirectory(ApiTestRun perfTest) {
	 ...
	 */
	public File getPerfTestStatisticPath(ApiTestRun perfTest) {
	 ...
	 * @return {@link PerfTest} report directory
	 */
	public File getPerfTestReportDirectory(ApiTestRun perfTest) {
	 ...
	 */
	public File getPerfTestCsvFile(ApiTestRun perfTest) {
