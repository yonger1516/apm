...
@Entity
@Table(name = "t_api_config_history")
public class ApiRunTestConfig extends BaseModel<ApiRunTestConfig> {
	...
	private org.ngrinder.model.RampUp rampUpType;
	...
	public void cloneTestConfig(ApiTestConfig config){
		this.agentCount=config.getAgentCount();
		this.duration=config.getDuration();
		this.ignoreSampleCount=config.getIgnoreSampleCount();
		this.param=config.getParam();
		this.processes=config.getProcesses();
		this.rampUpIncrementInterval=config.getRampUpIncrementInterval();
		this.rampUpInitCount=config.getRampUpInitCount();
		this.rampUpInitSleepTime=config.getRampUpInitSleepTime();
		this.rampUpStep=config.getRampUpStep();
		this.rampUpType=config.getRampUpType();
		this.region=config.getRegion();
		this.runCount=config.getRunCount();
		this.ignoreSampleCount=config.getIgnoreSampleCount();
		this.param=config.getParam();
		this.processes=config.getProcesses();
		this.rampUpIncrementInterval=config.getRampUpIncrementInterval();
		this.targetHosts=config.getTargetHosts();
		this.threads=config.getThreads();
		this.threshold=config.getThreshold();
		this.useRampUp=config.getUseRampUp();
		this.vuserPerAgent=config.getVuserPerAgent();
		this.safeDistribution=config.getSafeDistribution();
		this.samplingInterval=config.getSamplingInterval();
		this.scheduledTime=config.getScheduledTime();
		this.scriptName=config.getScriptName();
		this.scriptRevision=config.getScriptRevision();
		this.sendMail=config.getSendMail();
		this.rps=config.getRps();
		this.useFixedRateRPS=config.getUseFixedRateRPS();

		setCreatedDate(config.getCreatedDate());
		setLastModifiedUser(config.getLastModifiedUser());
		setLastModifiedDate(config.getLastModifiedDate());
		setCreatedUser(config.getCreatedUser());
