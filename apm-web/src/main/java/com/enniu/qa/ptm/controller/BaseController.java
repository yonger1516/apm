...
import com.enniu.qa.ptm.configuration.constant.WebConstants;
import com.enniu.qa.ptm.service.AnnouncementService;
...
public class BaseController implements WebConstants {
	...
	protected String getMessages(String key) {
		...
		if (null==userLanguage||userLanguage.isEmpty()){
			userLanguage = "en";
		}
