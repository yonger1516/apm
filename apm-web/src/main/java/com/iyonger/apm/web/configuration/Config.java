...
import com.iyonger.apm.web.spring.SpringContext;
import com.iyonger.apm.web.util.FileWatchdog;
import com.iyonger.apm.web.configuration.constant.DatabaseConstants;
...
import static org.ngrinder.common.util.Preconditions.checkNotNull;
  ...
  public class Config extends AbstractConfig implements ControllerConstants, ClusterConstants {
	  ...
	  public PropertiesWrapper getDatabaseProperties() {
		  ...
		  if (context.isUnitTestContext() && !databaseProperties.exist(DatabaseConstants.PROP_DATABASE_UNIT_TEST)) {
			  databaseProperties.addProperty(DatabaseConstants.PROP_DATABASE_UNIT_TEST, "true");
		  }
