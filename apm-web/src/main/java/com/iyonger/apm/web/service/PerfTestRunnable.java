...
import com.iyonger.apm.web.model.NullSingleConsole;
import com.iyonger.apm.web.plugin.PluginManager;
import com.iyonger.apm.web.service.listener.AgentDieHardListener;
import com.iyonger.apm.web.service.listener.AgentLostDetectionListener;
import com.iyonger.apm.web.service.listener.PerfTestSamplingCollectorListener;
import com.iyonger.apm.web.util.SingleConsoleCancellationException;
...
public class PerfTestRunnable implements ControllerConstants {
	...
	private boolean isSafeDistPerfTest(final PerfTest perfTest) {
		...
		if (config.isClustered()) {
			safeDist = config.getClusterProperties().getPropertyBoolean(ClusterConstants.PROP_CLUSTER_SAFE_DIST);
		}
		return safeDist;
	}
