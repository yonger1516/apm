 ...
 */
public class PinpointAgentInfo {

    public static final Comparator<PinpointAgentInfo> AGENT_NAME_ASC_COMPARATOR = new Comparator<PinpointAgentInfo>() {
        @Override
        public int compare(PinpointAgentInfo lhs, PinpointAgentInfo rhs) {
   ...
   /* @JsonInclude(Include.NON_NULL)
    ...
    public PinpointAgentInfo() {
    }

    public PinpointAgentInfo(AgentInfoBo agentInfoBo) {
   ...
   /* public AgentStatus getStatus() {
    ...
    public boolean equals(Object o) {
        ...
        PinpointAgentInfo pinpointAgentInfo = (PinpointAgentInfo) o;

        if (serviceTypeCode != pinpointAgentInfo.serviceTypeCode) return false;
        return !(agentId != null ? !agentId.equals(pinpointAgentInfo.agentId) : pinpointAgentInfo.agentId != null);
