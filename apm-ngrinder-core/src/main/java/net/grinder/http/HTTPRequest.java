...
import net.grinder.http.HTTPPlugin;
...
public class HTTPRequest {
	 ...
	 *
	 * @param defaultPairs  Default array.
	 * @param overridePairs Array to merge. Entries take precedence over
	 ...
	 * Makes an HTTP {@code DELETE} request.
	 *
	 * @param uri     The URI. If a default URL has been specified with {@link #setUrl},
	 ...
	 *                an absolute URL.
	 * @param headers Request headers. Overrides headers with matching names set by
	 *                {@link #setHeaders}.
	 * @return Contains details of the server's response.
	 * @throws Exception If an error occurs.
	 */
	 ...
	 *                  resolved relative to the default URL. Otherwise this value must be
	 *                  an absolute URL.
	 * @param queryData Request headers. Replaces all the values set by
	 *                  {@link #setFormData}.
	 * @param headers   Request headers. Overrides headers with matching names set by
	 *                  {@link #setHeaders}.
	 * @return Contains details of the server's response.
	 ...
	 *                resolved relative to the default URL. Otherwise this value must be
	 *                an absolute URL.
	 * @param data    Data to be submitted in the body of the request. Overrides the
	 ...
	 * @param headers     Request headers. Overrides headers with matching names set by
	 *                    {@link #setHeaders}.
	 * @param isMultipart {@code true} if request type is multipart/form-data.
	 * @return Contains details of the server's response.
	 * @throws Exception If an error occurs.
	 */
	public final HTTPResponse POST(final String uri,
	 ...
	 * {@link Statistics.StatisticsForTest#pauseClock() stopped} while this method
	 * is called).</p>
	 *
	...
	private abstract class AbstractRequest {
		...
		public final HTTPResponse getHTTPResponse()
			...
			final Grinder.ScriptContext scriptContext = plugin.getScriptContext();
