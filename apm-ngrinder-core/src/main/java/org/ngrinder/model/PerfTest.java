...
public class PerfTest extends BaseModel<PerfTest> {
	...
	@Expose
	@Cloneable
	@Column(name = "tag_string",length = 20)
	...
	@Column(name = "ignore_sample_count",length = 2)
	...
	@Expose
	@Cloneable
	@Column(name = "target_hosts",length = 50)
	...
	@Expose
	@Cloneable
	@Column(name = "threshold",length = 1)
	...
	@Column(name = "distribution_path",length = 100)
	/** The path used for file distribution */
	private String distributionPath;

	@Expose
	@Column(name = "progress_message", length = 100)
	private String progressMessage;

	@Column(name = "last_progress_message", length =100)
	private String lastProgressMessage;

	@Expose
	@Column(name = "test_comment", length = 100)
	...
	@Column(name = "running_sample", length = 1000)
	private String runningSample;

	@Column(name = "agent_stat", length = 1000)
	private String agentState;

	@Column(name = "monitor_stat", length = 1000)
